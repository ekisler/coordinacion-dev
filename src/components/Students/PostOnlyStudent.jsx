...
import { postOnlyStudent } from '../../store/actions/studentActions.js';
import AccessDenied from '../../utils/AccessDenied.jsx';

const PostOnlyStudents = () => {
  ...
  const handleSubmit = async (values, actions) => {
    try {
      ...
      await dispatch(postOnlyStudent(data));
      actions.resetForm();
      ...
      >
        <Heading size={{ base: "md", md: "lg", lg: "lg" }} mb={'12'} mt={'2'}>
          <Stack direction="row" align="center" justify="center">
            <GiArchiveRegister />
            <Text>Registrar Estudiante (Sin Rep.)</Text>
          </Stack>
        </Heading>
        <Formik
          enableReinitialize
                  ...
                  <Field name="studentLastName">
                    {({ field }) => (
                      <Input
                        ...
                        type="text"
                        placeholder="Ejem. Perez Rodriguez"
                        onBlur={e => {
                          field.onBlur(e);
                          updateReduxFormData(
                            'studentLastName',
...
export default PostOnlyStudents;
